                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                <!--begin:Heading-->
                                                <h4 class="fs-6 fs-lg-4 text-gray-800 fw-bold mt-3 mb-3 ms-4">کناری</h4>
                                                <!--end:Heading-->
                                                <!--begin:Menu item-->
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="asides/aside-1.html" class="menu-link">
                                                        ...
                                                        <span class="menu-title">فیلترها</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                <!--end:Menu item-->
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="asides/aside-2.html" class="menu-link">
                                                        ...
                                                        <span class="menu-title">سگمنت</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                <!--end:Menu item-->
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="asides/aside-3.html" class="menu-link">
                                                        ...
                                                        <span class="menu-title">تاریخچه جابجایی</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                <!--end:Menu item-->
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    ...
                                                    <a href="asides/aside-4.html" class="menu-link">
                                                        ...
                                                        <span class="menu-title">فعالیت پیک</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                                <!--end:Menu item-->
                                        ...
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mb-5 mb-lg-0 mx-lg-5">
                                            <div class="d-flex flex-column me-5">
                                                ...
                                                <div class="fs-7 fw-semibold text-muted">سفارشی کردن، پیش نمایش و صادرات</div>
                                            </div>
                                    ...
                                    <div class="col-lg-5 mb-3 py-lg-3 pe-lg-8 d-flex align-items-center">
                                        <img src="{{asset('/media/stock/900x600/45.jpg')}}" class="rounded mw-100" alt="" />
                                    </div>
                                    <!--end:Col-->
                                </div>
                                <!--end:Row-->
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/base/utilities" target="_blank" title="بیش از 200 کامپوننت داخلی، پلاگین و راه حل های آماده برای استفاده را بررسی کنید" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-icon">
														<i class="ki-duotone ki-rocket fs-2">
															<span class="path1"></span>
															<span class="path2"></span>
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-4">
                                            <a href="#" class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">
                                                ...
                                                <span class="fw-semibold">فیگما</span>
                                            </a>
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-5">
                            <a href="{{route('account.overview')}}" class="menu-link px-5">پروفایل من</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
